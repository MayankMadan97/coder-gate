...
class WebHookListenerServiceTest {
    ...
    void testHandleInstallationCreateInstallationRepository() {
        ...
        verify(repositoryServiceMock).addRepository(any(List.class),eq(userID));
    ...
    void testHandlePushEvent() {
        ...
        verify(repositoryServiceMock).addRepository(repositoryId,repoName,fork,setId,installationId);
