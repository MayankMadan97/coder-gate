...
public class PusherDTO implements Serializable
{
    ...
    public String toString() {
        ...
        sb.append(PusherDTO.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("name");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PusherDTO) == false) {
            return false;
        }
        PusherDTO rhs = ((PusherDTO) other);
