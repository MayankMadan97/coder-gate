...
public class Installation implements Serializable
{
     ...
     */
    public Installation(Integer id, Account account, String repositorySelection, String accessTokensUrl, String repositoriesUrl, String htmlUrl, Integer appId, String appSlug, Integer targetId, String targetType, Permissions permissions, List<String> events, String createdAt, String updatedAt, Object singleFileName, Boolean hasMultipleSingleFiles, List<Object> singleFilePaths, Object suspendedBy, Object suspendedAt) {
        super();
        this.id = id;
    ...
    public String toString() {
        ...
        sb.append(Installation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((this.repositoriesUrl == rhs.repositoriesUrl)||((this.repositoriesUrl!= null)&&this.repositoriesUrl.equals(rhs.repositoriesUrl)))&&((this.appSlug == rhs.appSlug)||((this.appSlug!= null)&&this.appSlug.equals(rhs.appSlug))))&&((this.accessTokensUrl == rhs.accessTokensUrl)||((this.accessTokensUrl!= null)&&this.accessTokensUrl.equals(rhs.accessTokensUrl))))&&((this.targetId == rhs.targetId)||((this.targetId!= null)&&this.targetId.equals(rhs.targetId))))&&((this.repositorySelection == rhs.repositorySelection)||((this.repositorySelection!= null)&&this.repositorySelection.equals(rhs.repositorySelection))))&&((this.suspendedAt == rhs.suspendedAt)||((this.suspendedAt!= null)&&this.suspendedAt.equals(rhs.suspendedAt))))&&((this.htmlUrl == rhs.htmlUrl)||((this.htmlUrl!= null)&&this.htmlUrl.equals(rhs.htmlUrl))))&&((this.targetType == rhs.targetType)||((this.targetType!= null)&&this.targetType.equals(rhs.targetType))))&&((this.singleFilePaths == rhs.singleFilePaths)||((this.singleFilePaths!= null)&&this.singleFilePaths.equals(rhs.singleFilePaths))))&&((this.createdAt == rhs.createdAt)||((this.createdAt!= null)&&this.createdAt.equals(rhs.createdAt))))&&((this.permissions == rhs.permissions)||((this.permissions!= null)&&this.permissions.equals(rhs.permissions))))&&((this.appId == rhs.appId)||((this.appId!= null)&&this.appId.equals(rhs.appId))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.suspendedBy == rhs.suspendedBy)||((this.suspendedBy!= null)&&this.suspendedBy.equals(rhs.suspendedBy))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.singleFileName == rhs.singleFileName)||((this.singleFileName!= null)&&this.singleFileName.equals(rhs.singleFileName))))&&((this.account == rhs.account)||((this.account!= null)&&this.account.equals(rhs.account))))&&((this.events == rhs.events)||((this.events!= null)&&this.events.equals(rhs.events))))&&((this.updatedAt == rhs.updatedAt)||((this.updatedAt!= null)&&this.updatedAt.equals(rhs.updatedAt))))&&((this.hasMultipleSingleFiles == rhs.hasMultipleSingleFiles)||((this.hasMultipleSingleFiles!= null)&&this.hasMultipleSingleFiles.equals(rhs.hasMultipleSingleFiles))));
    }
